...
<a href="{{route('eixo.create')}}" class="btn btn primary mt - 3">
...
<a href="{{route('eixo.graph')}}" class="btn btn primary mt - 3">
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000" class="bi bi-bar-chart-fill" viewBox="0 0 16 16">
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('eixo.report', $item->id)}}" target= "_blank" class="btn btn-warning">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#fff" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
